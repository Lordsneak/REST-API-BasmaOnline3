	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
	  ...
	  @Override
	    protected void successfulAuthentication(HttpServletRequest req,
	        ...
	        res.addHeader("nom_user", userDto.getNomUser());
	        res.addHeader("prenom_user", userDto.getPrenomUser());
	        res.addHeader("email", userDto.getEmail());
	        res.addHeader("role", userDto.getRoleUser());
	        
	        res.getWriter().write("{\"token\": \"" + token + "\", \"id\": \""+ userDto.getUserId() + "\", \"nom_user\": \""+ userDto.getNomUser() 
	        + "\", \"prenom_user\": \""+ userDto.getPrenomUser() + "\", \"email\": \""+ userDto.getEmail()+ "\"}");
